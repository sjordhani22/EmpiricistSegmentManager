...
public class listVideoSegmentsHandlerTest {
    ...
    @Test
    public void testlistVideoSegmentsHandler() {
        listVideoSegmentsHandler handler = new listVideoSegmentsHandler(s3Client);
